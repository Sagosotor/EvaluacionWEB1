...
// Nombre: Santiago Soto Ramirez.

echo("MOMENTO EVALUATIVO 1/ ELABORADO POR SANTIAGO SOTO RAMIREZ <br><br>");
...
echo("Ejercicio Tres <br><br>");

/* 3.Hacer un programa en PHP para la tienda Spring Step que tiene una promoción de descuento para vender al mayor, esta dependerá del
...
echo ("<br>.......................<br>");
echo("Ejercicio Cuatro <br><br>");

/*4. Hacer un programa en PHP para ayudar a un trabajador de Postobón a saber cuál será su sueldo semanal, se sabe que si trabaja 40 horas
...
echo ("<br>.......................<br>");
echo("Ejercicio Cinco <br><br>");

/*5.Bancolombia contrata sus servicios de desarrollador para realizar un programa en PHP que permita almacenar información de nombre,
...
echo ("<br>.......................<br>");
echo("Ejercicio Siete <br><br>");

/*7. Después de realizar una consulta en la base de datos DE LA JUGOSA SAS se tienen almacenados los valores de dicha consulta en un
arreglo denominado salpicon, el cual presenta la siguiente configuración:
[dulce1]=>”Banano”
[dulce2]=>”Manzana”
[dulce3]=>”Durazno”
[acido1]=>”Piña”
...
echo ("<br>.......................<br>");
echo("Ejercicio Ocho <br><br>");

/*8. La federación nacional de fútbol necesita de sus servicios como desarrollador de software, para codificar una función en PHP que permita
...
echo ("<br>.......................<br>");
echo("Ejercicio Nueve <br><br>");

/*9. La federación nacional de fútbol también necesita que usted codifique una nueva función para establecer el biotipo de los jugadores
...
echo ("<br>.......................<br>");
echo("Ejercicio Diez <br><br>");

/*10. El seleccionador nacional de la selección de fútbol de Colombia Carlos Queiroz, necesita de sus servicios como desarrollador de
software, para almacenar y organizar la información de los mejores jugadores colombianos alrededor del mundo, para ello el le suministra
la siguiente información:
INDICACIONES DEL TALLER 1
JUGADOR AÑO NACIMIENTO POSICION ESTATURA
Radamel Falcao 1986 Delantero 1,77 m
James Rodríguez 1991 Medio campista 1,81 m
...
Wilmar Barrios 1993 Medio campista 1,78 m
Mateus Uribe 1991 Medio Campista 1,80 m
Cree un arreglo multidimensional donde guarde la información de cada jugador calculando la edad y el biotipo de estos a partir de los
datos suministrados por Queiroz y muestre los resultados en pantalla uno a uno.*/
